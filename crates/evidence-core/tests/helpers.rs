...
use evidence_core::traits::GitProvider;
...
pub fn create_minimal_bundle(profile: evidence_core::Profile) -> (TempDir, std::path::PathBuf) {
    ...
    // env.json must deserialize cleanly into `evidence_core::EnvFingerprint`
    ...
    .unwrap_or_else(|_| panic!("recipe inputs gather from {bundle_dir:?}"));
...
pub fn make_trace_meta() -> evidence_core::trace::TraceMeta {
    evidence_core::trace::TraceMeta {
        document_id: "DOC-001".to_string(),
        revision: "1.0".to_string(),
    }
}

pub fn make_schema() -> evidence_core::trace::Schema {
    evidence_core::trace::Schema {
