...
/// Count entries in `evidence_core::trace::surfaces::KNOWN_SURFACES`.
///
...
/// `evidence_core::RULES` length — locked by bijection invariants,
...
/// `evidence_core::TERMINAL_CODES` length.
